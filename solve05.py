...
def main(argv):
  ...
  password2 = claripy.BVS('password0', 8*8)
  password3 = claripy.BVS('password0', 8*8)
  ...
  # (!)
  password0_address = 0x8519040
  initial_state.memory.store(password0_address, password0)
  password1_address = 0x8519048
  initial_state.memory.store(password1_address, password1)
  password2_address = 0x8519050
  initial_state.memory.store(password2_address, password2)
  password3_address = 0x8519058
