...
def main(argv):
  ...
  # (!)
  start_address = 0x80488E8 # :integer (probably hexadecimal)
  ...
  # (!)
  initial_state.regs.eax = password0 	#eax might try ecx just for the sake of it
  initial_state.regs.ebx = password1	#ebx
  initial_state.regs.edx = password2	#edx
